...
//	}
	...
	public void genererVoisin() {
		int indexI = generateur.nextInt(dimEtat); // on prend un index au hasard entre 0 et 99 (dimEtat=100=DIMENSION)
		int indexJ = indexI - 4 + generateur.nextInt(9); // on génère un indexJ dans indexI +/- 4 pour tenir compte de la
		//contrainte de vitesse ; un avion ne peut changer de rang au delà  de +/- 4
	  ...
	  /*******************************************************************************************************************/
	/* Retour a la solution prÃ©cÃ©dente */
	/*******************************************************************************************************************/
	...
	public double calculCritere() {
		...
		// l'index de tabAvions correspond Ã  l'identifiant avion de 0 Ã  99
		//idAvions contient les avions identifiÃ©s par un chiffre de 0 Ã  99
