...
public class RecuitKP {
	...
	// Réponses question 2 : 
	// xi variable de décision 1 on met l'objet dans le sac, 0 on ne le prend pas
	//  somme des xi*vi = V valeur contenue dans le sac à maximiser
	// s.t. P = somme xi*pi < C capacité
	/*******************************************************/
