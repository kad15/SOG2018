...
public class RecuitSimple {
	...
	private static final int DIMENSION = 1000;
	 ...
	 // Réponse questions exo 1
	// objectif = somme des xi à maximiser ou minimiser
	//  état : vecteur booléen de dim n
	...
	// *****************************************
	  ...
	  public EtatSimple refroidissement(double Tinit) {
		double yi = 0.0, yj = 0.0; // critÃ¨res courant yi et critÃ¨re voisin mis Ã  0
	    double T = Tinit;
	    EtatSimple xi = new EtatSimple(DIMENSION);
